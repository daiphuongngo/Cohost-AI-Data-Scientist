...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-dir', type=str, default='data-bin/mtet_en_vi', help='Data location')
    parser.add_argument('--max-updates', type=int, default=50000, help='Max. updates')
    ...
    parser.add_argument('--save-dir', type=str, default='./results_wmt14_en2fr', help='Results directory')
